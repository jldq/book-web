<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReaderUpdate.aspx.cs" Inherits="admin_ReaderUpdate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
                     <asp:Panel ID="Panel1" runat="server">
                          <table style="margin-left:20%;" class="auto-style21">
                            <tr>
                                <td colspan="2" style="text-align:center;font-size:larger;font-weight:bolder" class="auto-style14">修改读者</td>
                            </tr>
                            <tr>
