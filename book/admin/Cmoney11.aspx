<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Cmoney11.aspx.cs" Inherits="admin_Cmoney11" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:Label ID="Label2" runat="server" style="margin:15%;font-size:larger;"></asp:Label>
</asp:Content>
