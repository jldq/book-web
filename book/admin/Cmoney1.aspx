<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Cmoney1.aspx.cs" Inherits="admin_Cmoney1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table style="margin-left:20%;" class="auto-style21">
                            <tr>
                                <td colspan="2" style="text-align:center;font-size:larger;font-weight:bolder" class="auto-style14">图书丢失</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="不能为空" ControlToValidate="TextBox2" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
