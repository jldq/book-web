<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Cmoney3.aspx.cs" Inherits="admin_Cmoney3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table style="margin-left:20%;" class="auto-style21">
                            <tr>
                                <td colspan="2" style="text-align:center;font-size:larger;font-weight:bolder" class="auto-style14">书标脱落</td>
                            </tr>
                            <tr>
