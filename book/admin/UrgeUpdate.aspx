<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UrgeUpdate.aspx.cs" Inherits="admin_UrgeUpdate" %>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <table style="width:100%;height:320px">
                            <tr>
                                <td colspan="2" style="text-align:center;font-size:larger;font-weight:bolder">修改催还记录</td>
                            </tr>
                            <tr>
                                <td class="auto-style3">催还编号:</td>
                                <td  class="auto-style9"><asp:Label ID="Label1" runat="server" Text='<%# Bind("c_id") %>'></asp:Label></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td  class="auto-style3">催还时间:</td>
                                <td  class="auto-style9">
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("c_riqi") %>'></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style4">读者:</td>
                                <td class="auto-style10">
                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("c_name") %>'></asp:Label></td>
                            </tr>
                         </table>
                      </ItemTemplate>
                </asp:TemplateField>
