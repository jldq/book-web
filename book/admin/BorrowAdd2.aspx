<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BorrowAdd2.aspx.cs" Inherits="admin_BorrowAdd2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="42%" AllowPaging="True"  style="margin-left:5%;margin-top:20px;line-height:35px"
